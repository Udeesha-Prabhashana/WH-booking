    ...
    return (
        <div className="header">
            <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
                { type !== "list" &&    
                    <>
                        <h1 className="headerTitle">Wellcome to World Hotels</h1>
                        <p className="headerDesc">Join our WH Booking family today and enjoy lifetime discounts on your travels</p>
